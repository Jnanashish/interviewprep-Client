...
const Jobcard = (props) =>{ 
    ...
    const {title, degree, batch, imagePath, jobtype, location, experience,  jdpage} = props.data
    ...
    return (
        <div className={styles.jobcard_con}>
            <div className = {styles.companylogo_con}>
                ...
                {imagePath === 'none' && 
                    <div className={styles.logotext}><p>{title[0]}</p></div>
                }
            ...
            <div className={styles.jobdetails}>
                ...
                {experience !=="N" && <div className={styles.jobdetails_item}><h5>Exp :</h5><p>{experience}</p></div>}
                {experience ==="N" && location !== "N" && <div className={styles.jobdetails_item}><h5>Location :</h5><p>{location}</p></div>}
                {experience ==="N" && location === "N" && <div className={styles.jobdetails_item}><h5>Jobtype :</h5><p>{jobtype}</p></div>}
            </div>
