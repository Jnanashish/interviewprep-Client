...
const JobDesc = () => {
    ...
    const wmsg =
        "Hello, " + data.title + ". %0aCheck here : " + document.location.href;
    const sendwhatsappmsg = () => {
        window.location.href = `whatsapp://send?text=${wmsg}`;
    };
            ...
            <div className={styles.jobddesc_con}>
                <div className={styles.jd_con}>
                    {data.length !== 0 && (
                        <div>
                            {/* Title of the job */}
                            <h1 className={styles.jd_title}>{data.title}</h1>
                            <div>
                                <a
                            ...
                            {data.jobdesc !== "<p>N</p>" && (
                                <div className={styles.detail_con}>
                                    <h2 className={styles.jd_subheading}>
                                        Job Description
                                    </h2>
                            ...
                            <div className={styles.detail_con}>
                                {data.eligibility !== "<p>N</p>" &&
                                    data.eligibility !== "N" && (
                                        <div>
                                            <h2
                                                className={
                                                    styles.jd_subheading
                                                }>
                                                Eligibility
                                            </h2>
                            ...
                            {data.lastdate !== "N" && (
                                <span className={styles.lastdate}>
                                    <h5>
                                        Last date to Apply : {data.lastdate}
                                    </h5>
                                </span>
                            )}
