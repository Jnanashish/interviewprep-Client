...
function LinkdaDesktop() {
    ...
    return (
        <div className={styles.linda_con}>
            ...
            {data.map(item => {
                return(
                    <div className={styles.da_item}>
                        <a  onClick={() => countAdLinkClick(item._id)} href={item.link}>✅ {item.title}</a>
                        <br />
                    </div>
                )
            })}
            ...
            <div className={styles.da_item}>
                <a href= "https://t.me/interviewpreptech">✅ Free ebooks & DSA notes | Join Telegram</a>
                <br />
            </div>
            {data.length <= 2 && <div className={styles.da_item}>
                <a className={styles.linkedin_con} href= "https://t.me/interviewpreptech">
                    <img src="https://i.ibb.co/QbpGFMN/3d-plastilina-linkedin-1-min-1.png" alt="linkedin logo"/>
